// src/mastra/domains/test-telegram-agent/agent.ts
...
import { TelegramService } from "./services/test-telegram-agent-service";
...
export const TestTelegramAgentAgent = new Agent({
  name: "test-telegram-agent-agent",
...
- Mantenha logs detalhados para debugging`,
  ...
  memory: new Memory({
    storage: new LibSQLStore({
      url: "file:./test-telegram-agent-memory.db"
    })
  }),
